import svgPaths from "./svg-j8hx02d7po";
...
function Text1() {
  return (
    <div className="bg-[rgba(0,249,228,0.1)] flex-[1_0_0] h-[19.993px] min-h-px min-w-px relative rounded-[13981000px]" data-name="Text">
      <div className="flex flex-row items-center size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[10px] py-[2px] relative size-full">
          <p className="font-['Inter:Medium',sans-serif] font-medium leading-[16px] not-italic relative shrink-0 text-[#00f9e4] text-[12px] whitespace-nowrap">Em atraso</p>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="absolute left-[16px] size-[15.996px] top-[9.99px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.9961 15.9961">
        <g clipPath="url(#clip0_18_569)" id="Icon">
...
function Icon3() {
  return (
    <div className="relative shrink-0 size-[15.996px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.9961 15.9961">
        <g clipPath="url(#clip0_18_586)" id="Icon">
...
function Icon4() {
  return (
    <div className="relative shrink-0 size-[15.996px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.9961 15.9961">
        <g clipPath="url(#clip0_18_564)" id="Icon">
...
function Icon5() {
  return (
    <div className="relative shrink-0 size-[15.996px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.9961 15.9961">
        <g clipPath="url(#clip0_18_572)" id="Icon">
...
function Text9() {
  return (
    <div className="bg-[rgba(0,249,228,0.1)] h-[19.993px] relative rounded-[13981000px] shrink-0 w-[67.663px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[8px] py-[2px] relative size-full">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[16px] not-italic relative shrink-0 text-[#00f9e4] text-[12px] whitespace-nowrap">Atrasado</p>
      </div>
    </div>
  );
}
