import svgPaths from "./svg-n2ywf6gq74";
  ...
  return (
    <div className="absolute left-[16px] size-[15.996px] top-[9.99px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.9961 15.9961">
        <g id="Icon">
          <path d={svgPaths.p269c5200} id="Vector" stroke="var(--stroke-0, #0A0A0A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33301" />
          <path d={svgPaths.p3ec70300} id="Vector_2" stroke="var(--stroke-0, #0A0A0A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33301" />
          <path d="M7.99805 9.99756V1.99951" id="Vector_3" stroke="var(--stroke-0, #0A0A0A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33301" />
        </g>
      </svg>
    </div>
  );
...
function Button() {
  return (
    <div className="bg-[#00f9e4] h-[35.983px] relative rounded-[50px] shrink-0 w-[160.716px]" data-name="Button">
      <Icon4 />
      <p className="-translate-x-1/2 absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-[92.49px] not-italic text-[#0a0a0a] text-[14px] text-center top-[8.24px] whitespace-nowrap">Baixar Relatório</p>
    </div>
  );
}
...
function Button1() {
  return (
    <div className="bg-[#00f9e4] h-[35.983px] relative rounded-[50px] shrink-0 w-[62.624px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="-translate-x-1/2 absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-[31.5px] not-italic text-[#0a0a0a] text-[14px] text-center top-[8.24px] whitespace-nowrap">Hoje</p>
      </div>
    </div>
  );
}
...
function Button2() {
  return (
    <div className="bg-[#1a1a1a] h-[35.983px] relative rounded-[50px] shrink-0 w-[86.016px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
...
function Button3() {
  return (
    <div className="bg-[#1a1a1a] h-[35.983px] relative rounded-[50px] shrink-0 w-[60.534px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
...
function Icon6() {
  return (
    <div className="absolute left-0 size-[15.996px] top-[2px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.9961 15.9961">
        <g clipPath="url(#clip0_20_734)" id="Icon">
...
function Icon7() {
  return (
    <div className="absolute left-0 size-[15.996px] top-0" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.9961 15.9961">
        <g clipPath="url(#clip0_20_730)" id="Icon">
    ...
    <div className="relative shrink-0 size-[20px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Icon">
          ...
          <path d={svgPaths.p2c4f400} id="Vector_2" stroke="var(--stroke-0, #0A0A0A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d={svgPaths.p2f5eb900} id="Vector_3" stroke="var(--stroke-0, #0A0A0A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
        </g>
      </svg>
    </div>
  );
...
function Text56() {
  return (
    <div className="h-[19.993px] relative shrink-0 w-[68.092px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="-translate-x-1/2 absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-[34px] not-italic text-[#0a0a0a] text-[14px] text-center top-[0.25px] whitespace-nowrap">Check-ins</p>
      </div>
    </div>
  );
}
